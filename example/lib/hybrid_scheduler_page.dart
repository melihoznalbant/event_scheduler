...
class HybridSchedulerPage extends StatefulWidget {
  const HybridSchedulerPage({super.key});

  @override
  State<HybridSchedulerPage> createState() => _HybridSchedulerPageState();
}

class _HybridSchedulerPageState extends State<HybridSchedulerPage> {
  int _counter = 0;
  bool _isActive = false;
  final String _eventKey = 'hybrid_scheduler_page_event';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Hybrid Scheduler (5 clicks, 1 min) Page'),
      ...
      body: Column(
        children: [
          Container(
            ...
            child: const Text(
              'Scenario: This page demonstrates an event scheduler based on both click count and time. '
              'The first event triggers after 5 clicks and then repeats every 2 clicks. '
              'However, these recurrences only continue for 1 minute. '
              'When the minute is up, the event ends and a notification is shown.',
